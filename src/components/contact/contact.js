      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <a href="mailto:matimonti24@gmail.com"  target="_blank">Enviar un mensaje</a>
          </article>
          ...
          <article className="contact__option">
            ...
            <a href="https://m.me/matias-emanuel-monti-87b795128"  target="_blank">Enviar un mensaje</a>
          </article>
          ...
          <article className="contact__option">
            ...
            <a href="https://api.whatsapp.com/send?phone=543537320999"  target="_blank">Enviar un mensaje</a>
          </article>
        </div>
